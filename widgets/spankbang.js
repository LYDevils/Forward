...
searchVideos = async (params = {}) => {
  return buildSampleVideos('spankbang', 'https://spankbang.com', params.keyword);
};

getVideoDetail = async (params = {}) => {
  return buildSampleDetail('spankbang', 'https://spankbang.com', params.url, params.keyword);
};

getCategories = async () => {
  const categories = await loadCategories('https://spankbang.com', 'spankbang');
  return categories.length > 0 ? categories : buildSampleCategories('spankbang', 'https://spankbang.com');
};
