...
searchVideos = async (params = {}) => {
  return buildSampleVideos('redtube', 'https://www.redtube.com', params.keyword);
};

getVideoDetail = async (params = {}) => {
  return buildSampleDetail('redtube', 'https://www.redtube.com', params.url, params.keyword);
};

getCategories = async () => {
  const categories = await loadCategories('https://www.redtube.com', 'redtube');
  return categories.length > 0 ? categories : buildSampleCategories('redtube', 'https://www.redtube.com');
};
