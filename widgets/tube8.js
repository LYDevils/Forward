...
searchVideos = async (params = {}) => {
  return buildSampleVideos('tube8', 'https://www.tube8.com', params.keyword);
};

getVideoDetail = async (params = {}) => {
  return buildSampleDetail('tube8', 'https://www.tube8.com', params.url, params.keyword);
};

getCategories = async () => {
  const categories = await loadCategories('https://www.tube8.com', 'tube8');
  return categories.length > 0 ? categories : buildSampleCategories('tube8', 'https://www.tube8.com');
};
