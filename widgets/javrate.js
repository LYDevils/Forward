...
searchVideos = async (params = {}) => {
  return buildSampleVideos('javrate', 'https://javrate.com', params.keyword);
};

getVideoDetail = async (params = {}) => {
  return buildSampleDetail('javrate', 'https://javrate.com', params.url, params.keyword);
};

getCategories = async () => {
  const categories = await loadCategories('https://javrate.com', 'javrate');
  return categories.length > 0 ? categories : buildSampleCategories('javrate', 'https://javrate.com');
};
