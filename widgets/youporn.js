...
searchVideos = async (params = {}) => {
  return buildSampleVideos('youporn', 'https://www.youporn.com', params.keyword);
};

getVideoDetail = async (params = {}) => {
  return buildSampleDetail('youporn', 'https://www.youporn.com', params.url, params.keyword);
};

getCategories = async () => {
  const categories = await loadCategories('https://www.youporn.com', 'youporn');
  return categories.length > 0 ? categories : buildSampleCategories('youporn', 'https://www.youporn.com');
};
