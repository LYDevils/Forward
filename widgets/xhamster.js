...
searchVideos = async (params = {}) => {
  return buildSampleVideos('xhamster', 'https://xhamster.com', params.keyword);
};

getVideoDetail = async (params = {}) => {
  return buildSampleDetail('xhamster', 'https://xhamster.com', params.url, params.keyword);
};

getCategories = async () => {
  const categories = await loadCategories('https://xhamster.com', 'xhamster');
  return categories.length > 0 ? categories : buildSampleCategories('xhamster', 'https://xhamster.com');
};
