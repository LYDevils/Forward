...
async function extractVideo(url) {
  ...
  try {
    ...
    throw new Error(`Failed to extract video from vod: ${error.message}`);
  }
}
...
async function search(keyword, options = {}) {
  ...
  try {
    ...
    throw new Error(`Failed to search vod: ${error.message}`);
  }
}
...
async function getVideoInfo(url) {
  ...
  try {
    ...
    throw new Error(`Failed to get video info from vod: ${error.message}`);
  }
}
